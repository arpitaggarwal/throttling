...
import com.throttling.executor.BlockingThreadPoolExecutor;
import com.throttling.executor.CustomThreadPoolExecutor;
import com.throttling.task.DemoTask;
...
public class DemoExecutor {
	...
	public static void main(String[] args) {
		...
		BlockingQueue<Runnable> blockingQueue = new ArrayBlockingQueue<Runnable>(
				50);
		BlockingThreadPoolExecutor executor = new BlockingThreadPoolExecutor(10,
